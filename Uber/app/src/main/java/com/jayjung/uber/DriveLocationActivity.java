...
public class DriveLocationActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_drive_location);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        markers.add(mMap.addMarker(new MarkerOptions().position(requestLocation).title("Your Location").icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_CYAN))));
        markers.add(mMap.addMarker(new MarkerOptions().position(driverLocation).title("Request Location")));
